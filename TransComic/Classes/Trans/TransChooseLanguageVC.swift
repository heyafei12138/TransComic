...
struct LanguageItem {
 ...
 let targetlanguages: [LanguageItem] = [
    .init(name: "简体中文".localized(), code: "zh-CHS"),
    .init(name: "中文繁体".localized(), code: "zh-CHT"),
    .init(name: "英语".localized(), code: "en"),
    .init(name: "日语".localized(), code: "ja"),
    .init(name: "韩语".localized(), code: "ko"),
    .init(name: "阿拉伯语".localized(), code: "ar"),
    .init(name: "德语".localized(), code: "de"),
    .init(name: "西班牙语".localized(), code: "es"),
    .init(name: "法语".localized(), code: "fr"),
    .init(name: "印地语".localized(), code: "hi"),
    .init(name: "印度尼西亚语".localized(), code: "id"),
    .init(name: "意大利语".localized(), code: "it"),
    .init(name: "荷兰语".localized(), code: "nl"),
    .init(name: "葡萄牙语".localized(), code: "pt"),
    .init(name: "俄语".localized(), code: "ru"),
    .init(name: "泰语".localized(), code: "th"),
    .init(name: "越南语".localized(), code: "vi"),
